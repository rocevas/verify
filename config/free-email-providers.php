...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | List of free email provider domains. These domains are considered
    | free email providers (like Gmail, Yahoo, etc.) and are typically
    | used for personal email addresses.
    |
    | This list is imported from the Go email-verifier project and contains
    | 8,747+ free email provider domains.
    |
    | Last updated: 2026-01-03 21:11:20
    |
    | To update this list, run:
    | php artisan import:free-email-providers
    |
    */
